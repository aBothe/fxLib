...
extern(Windows)
{
	...
	export void PostQuitMessage(int nExitCode) nothrow;
...
enum :
	...
	int GetWindowLongA(HWND hWnd,int nIndex) nothrow;
	int SetWindowLongA(HWND hWnd,int nIndex,int dwNewLong) nothrow;
	int* SetWindowLongPtrA(HWND hWnd,int nIndex,int* dwNewLong) nothrow;
	int* GetWindowLongPtrA(HWND hWnd,int nIndex) nothrow;
