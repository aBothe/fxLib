...
private void* getProc(string procname) {
	...
	if (symbol is null) {
		writeln("Failed to load WGL proc address " ~ procname );
	}
	return (symbol);
}
...
alias HGLRC function(HDC) pfwglCreateContext;
...
pfwglCreateContext		wglCreateContext=void;
